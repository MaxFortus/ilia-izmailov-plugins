...
The autonomous agent team (`/team-feature`) determines technical details itself: stack, patterns, risks, complexity, affected files, testing strategy. Asking the user about these wastes time and creates friction. The interview captures ONLY what codebase analysis cannot reveal.
...
- [ ] Brief fits in ~200 words (it becomes one argument to /team-feature)
